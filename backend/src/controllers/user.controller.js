...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if (!createdUser) {
        throw new ApiError(500, "Something went wrong while creating user in the database");
    }

    const responsePayload = new ApiResponse(200, createdUser, "User registered Successfully");
